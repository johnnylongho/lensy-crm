...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'lead' CHECK (status IN ('lead', 'deposited', 'shot', 'editing', 'done', 'cancelled', 'cho_coc', 'cho_xac_nhan_coc', 'da_chot', 'da_tra_file', 'hoan_thanh', 'da_huy')),
